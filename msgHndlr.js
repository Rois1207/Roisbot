...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const mess = {
            ...
            error: {
                St: '[❗] Goblok kirim gambar dengan caption *!sticker* atau tag gambar yang sudah dikirim',
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/imzay', donate)
            break
        case '!tts':
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '6285784150199@c.us')
            break
        case '!ig':
        ...
        case '!readme':
            ...
            break
        case '!info':
            client.sendLinkWithAutoPreview(from, 'https://github.com/ImZayy/zaybotWA', info)
            break
        case '!snk':
